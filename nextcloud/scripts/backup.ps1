# TODO structure please, functions, vars etc.

### Main config ###
$currentDate=$(Get-Date -UFormat "%Y%m%d%R") | ForEach-Object { $_ -replace ":", "" }
...
### Params ###
#loescht Backups, die aelter als 14 Tage sind # TODO REMOVE OLD BACKUPS
$backupalter="14"
